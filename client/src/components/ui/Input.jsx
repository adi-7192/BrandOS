export default function Input({ label, tooltip, error, required, className = '', ...props }) {
  return (
    <div className="flex flex-col gap-1">
      ...
      <input
        className={`w-full rounded-lg border border-gray-300 px-3 py-2.5 text-sm placeholder-gray-400 focus:border-gray-900 focus:outline-none focus:ring-1 focus:ring-gray-900 disabled:bg-gray-50 ${error ? 'border-red-400' : ''} ${className}`}
        {...props}
      />
